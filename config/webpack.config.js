  ...
  return {
        ...
        new TerserPlugin({
          terserOptions: {
            ...
            compress: {
              ...
              inline: 2,
              drop_debugger: isEnvProduction, // 打包编译过滤debugger
              drop_console: isEnvProduction, // 打包编译过滤console
            },
            mangle: {
              safari10: true,
            },
    ...
    resolve: {
      ...
      alias: {
        ...
        '@': paths.appSrc,
        SRC_COMP: paths.appComp,
        SRC_CONFIG: paths.appConfig,
        SRC_PAGE: paths.appPages,
        SRC_UTILS: paths.appUtils,
        SRC_LAYOUT: paths.appLayout,
        SRC_API: paths.appApi,
        SRC_ASSETS: paths.appAssets,
