...
const theme = {
    ...
    "background-active": "#00C9C3",

    "form-border": "#C5CCD3",
    "form-font": "#505E7C",
    "form-back": "#FFFFFF",
    "form-border-on": "#00C9C3",
    "form-font-on": "#00C9C3",
    "form-back-on": "#00C9C3",
    ...
    //--------------------------tooltip 仪表盘深色---------------------------------//
    'dark-tooltip-back': '#28323E',
    'dark-tooltip-border': 'rgba(0,0,0,0.3)',
    'dark-tooltip-font': '#6E7F90',
    'dark-tooltip-shadow': 'rgba(0,0,0,0.5)',

    //--------------------------message 仪表盘深色---------------------------------//
    'dark-message-back': 'rgba(0,0,0,0.75)',
    'dark-message-border': 'rgba(0,0,0,0.3)',
    'dark-message-font': '#ffffff',
    'dark-message-shadow': 'rgba(0,0,0,0.4)',
